 ...
 *
 * @wordpress-plugin
 * Plugin Name: SSM Clients
 * Plugin URI:  http://secretstache.com
 * Description: Enables a Client Custom Post Type.
 * Version:     0.1.0
 * Author:      Secret Stache Media
 * Author URI:  http://secretstache.com
 * Text Domain: ssm-clients
 * License:     GPL-2.0+
...
$post_type_registrations = new SSM_Clients_Registrations;

// Instantiate main plugin file, so activation callback does not need to be static.
$post_type = new SSM_Clients( $post_type_registrations );
...
if ( is_admin() ) {
	...
	$post_type_admin = new SSM_Clients_Admin( $post_type_registrations );
